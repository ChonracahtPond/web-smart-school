            ...
            <ul class="space-y-4">
                <li>
                    <a href="?page=dashboard" class="flex items-center p-2 text-base font-normal text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="ml-3">ระบบผู้ดูแล</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <ul id="dropdown-Manage-users" class="hidden py-2 space-y-2">
                        <li>
                            <a href="?page=ManageUsers" class="flex items-center w-full p-2 text-base font-normal text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">เพิ่ม/ลบ/อัพเดต</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-Manage-courses" class="hidden py-2 space-y-2">
                        ...
                        <!-- <li>
                            <a href="#" class="flex items-center w-full p-2 text-base font-normal text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">ตั้งค่ารายวิชา</a>
                        </li> -->
                    </ul>
                </li>
                ...
                <!-- <li>
                    ...
                    <ul id="dropdown-Manage-reports" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#" class="flex items-center w-full p-2 text-base font-normal text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">สร้างรายงาน</a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center w-full p-2 text-base font-normal text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">วิเคราะห์สถิติ</a>
                        </li>
