            ...
            <ul class="space-y-4">
                <li>
                    <a href="?page=dashboard" class="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-white hover:text-gray-500 dark:hover:bg-gray-700">
                        <svg class="w-6 h-6 text-white   transition duration-75 hover:text-gray-500 group-hover:text-gray-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
