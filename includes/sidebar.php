            ...
            <ul class="space-y-4">
                ...
                <li>
                    ...
                    <ul id="dropdown-Manage-users" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="?page=manage_attendance" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">ขาด/ลา/มาสาย</a>
                        </li>
                    </ul>
                </li>
                <!----------------------------------- end user ----------------------------------->
                ...
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-Manage-courses" data-collapse-toggle="dropdown-Manage-courses">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 490.1 490.1" xml:space="preserve">
                            <g>
                                <g>
                ...
                <li>
                    ...
                    <ul id="dropdown-ManageBook" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">ข้อมูลหนังสือทั้งหมด</a>
                        </li>
