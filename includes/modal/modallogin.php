...
<!-- <script>
        ...
        function showToast(status) {
            ...
            if (status === 'success') {
                ...
                successToast.classList.add('toast-enter-active');
                setTimeout(() => {
                ...
                errorToast.classList.add('toast-enter-active');
                setTimeout(() => {
        ...
        // Show the toast based on the status stored in localStorage
        window.onload = function() {
            const status = localStorage.getItem('status');
            if (status) {
                showToast(status);
                // Remove status from localStorage after displaying the toast
