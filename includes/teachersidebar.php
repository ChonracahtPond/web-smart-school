<div class="flex h-screen">
    ...
    <ul id="dropdown-class-room" class="hidden py-2 space-y-2">
        <li>
            <a href="?page=your_classroom" class="flex items-center w-full p-2 text-base font-normal text-white rounded-lg hover:bg-gray-100 hover:text-gray-800 dark:text-white dark:hover:bg-gray-700 pl-11">ห้องเรียนของคุณ</a>
        </li>
        <li>
