    ...
    <style type="text/css">
        * { margin: 0; padding: 0; text-indent: 0; }
        ...
        .table-wrapper {
         ...
         .box { /* ใช้ .box แทน div.box */
            width: 20px; /* กำหนดความกว้างของกล่อง */
            height: 20px; /* กำหนดความสูงของกล่อง */
            border: 2px solid black; /* กำหนดเส้นขอบสีดำ ความหนา 2px */
        ...
        .row1 { 
            display: flex;
            flex-wrap: wrap; /* ทำให้กล่องสามารถห่อหุ้มไปยังบรรทัดถัดไปได้ */
            flex-direction: row-reverse; /* จัดเรียงกล่องในแถวจากขวาไปซ้าย */
        }
