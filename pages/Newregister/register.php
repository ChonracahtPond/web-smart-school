...
<body class=" bg-gray-100">
    ...
    <div class="container mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form method="POST" action="edit/insert.php" enctype="multipart/form-data" class="space-y-4">
            ...
            <p class="text-red-500">* กรุณาอ่านก่อนยืนยันข้อมูลข้าพเจ้าของรับรองว่าข้อความข้างต้นเป็นความจริงทุกประการ และมีคุณสมบัติตามหลักสูตรการศึกษานอกระบบ
                ระดับการศึกษาขั้นพื้นฐาน พุทธศักราช 2551 และไม่อยู่ระหว่างการศึกษาในระบบโรงเรียนทุกสังกัดตลอดระยะเวลาที่เรียนหลักสูตรการศึกษานอกระบบ
                ...
                หรือไม่นำหลักฐานมาแสดงตามเวลาที่กำหนด ข้าพเจ้ายินยอมให้คัดชื่อออก และหากตรวจสอบพบภายหลังที่จบหลักสูตรไปแล้ว
