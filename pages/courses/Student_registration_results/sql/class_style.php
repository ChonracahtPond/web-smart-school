...
$elective_credits_pathom_style1 = ($elective_credits_pathom >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_pathom_style2 = ($elective_credits_pathom >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_pathom_style3 = ($elective_credits_pathom >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_pathom_style4 = ($elective_credits_pathom >= 12) ? 'text-green-500' : 'text-red-500';


$mandatory_credits_morton_style = ($mandatory_credits_morton >= 5) ? 'text-green-500' : 'text-red-500';
$mandatory_credits_morton_style1 = ($mandatory_credits_morton1 >= 12) ? 'text-green-500' : 'text-red-500';
...
$elective_credits_morton_style = ($elective_credits_morton >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morton_style1 = ($elective_credits_morton >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morton_style2 = ($elective_credits_morton >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morton_style3 = ($elective_credits_morton >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morton_style4 = ($elective_credits_morton >= 12) ? 'text-green-500' : 'text-red-500';


$mandatory_credits_morpai_style = ($mandatory_credits_morpai >= 5) ? 'text-green-500' : 'text-red-500';
$mandatory_credits_morpai_style1 = ($mandatory_credits_morpai1 >= 12) ? 'text-green-500' : 'text-red-500';
...
$elective_credits_morpai_style = ($elective_credits_morpai >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morpai_style1 = ($elective_credits_morpai >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morpai_style2 = ($elective_credits_morpai >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morpai_style3 = ($elective_credits_morpai >= 12) ? 'text-green-500' : 'text-red-500';
$elective_credits_morpai_style4 = ($elective_credits_morpai >= 12) ? 'text-green-500' : 'text-red-500';