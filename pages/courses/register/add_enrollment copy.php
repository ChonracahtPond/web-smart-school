...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $course_ids = $_POST['course_id']; // course_ids เป็น array
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 w-full max-w-md mx-auto mt-20">
        ...
        <form method="POST" action="">
            ...
            <div class="mb-4">
                ...
                <div id="course_list">
                    <div class="flex mb-2">
                        <select name="course_id[]" class="form-select mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        ...
                        <button type="button" class="bg-red-500 text-white px-2 ml-2 rounded-lg shadow-lg hover:bg-red-600 remove-course">Remove</button>
                    </div>
                </div>
                <button type="button" id="addCourse" class="bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-green-600 mt-2">Add Course</button>
            </div>
            <div class="mb-4">
