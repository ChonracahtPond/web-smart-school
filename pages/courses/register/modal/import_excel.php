...
<div id="importModal" class="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center hidden">
    <div class="modal-content bg-white rounded shadow-lg p-6 w-[500px]">
        ...
        <form action="../exports/enrollments/import_excel.php" method="POST" enctype="multipart/form-data" class="bg-white">
            ...
            <div class="flex justify-end mt-4">
                ...
                <button type="button" class="close ml-2 bg-red-500 text-white px-4 py-2 rounded">ปิด</button>
            </div>
        </form>
    </div>
</div>
