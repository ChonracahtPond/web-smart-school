    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex space-x-4">
                ...
                <a href="?page=add_exams_Midterm" class="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-blue-600">
                    <svg class="w-5 h-5 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="flex justify-center space-x-2">
                                ...
                                <a href="?page=edit_exam_Midterm&id=<?php echo $row['exam_id']; ?>" class="bg-blue-500 text-white font-bold h-10 w-18 py-1 px-2 rounded hover:bg-blue-600 transition duration-200 flex items-center">
                                ...
                                <a href="?page=delete_exam_Midterm&id=<?php echo $row['exam_id']; ?>" class="bg-red-500 text-white font-bold py-1 px-2 rounded hover:bg-red-600 transition duration-200 flex items-center h-10 w-18" onclick="return confirm('คุณแน่ใจหรือไม่ว่าจะลบการลงทะเบียนนี้?')">
