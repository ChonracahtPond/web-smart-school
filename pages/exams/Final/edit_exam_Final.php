...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">แก้ไขการสอบปลายภาค</h2>
    <form method="POST" action="" class="bg-white shadow-md rounded-lg p-8 space-y-6">
        ...
        <div class="flex justify-between">
            ...
            <a href="?page=Manage_exam_Final" class="mt-2 bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded hover:bg-gray-400 transition duration-200">ยกเลิก</a>
        </div>
    </form>
</div> 