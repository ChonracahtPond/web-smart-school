        ...
        <div class="bg-white shadow-lg rounded-lg p-6 flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="bg-blue-700 p-4 rounded-lg shadow-md">
                    ...
                    <p class="text-lg font-semibold text-white ml-2">ชาย <span class="text-1xl font-bold text-blue-300"><?php echo htmlspecialchars($male_count); ?></span> คน</p>
                    <p class="text-lg font-semibold text-white ml-2">หญิง <span class="text-1xl font-bold text-blue-300"><?php echo htmlspecialchars($female_count); ?></span> คน</p>
                </div>
                ...
                <div class="bg-green-700 p-4 rounded-lg shadow-md">
                    ...
                    <p class="text-lg font-semibold text-white ml-2">ชาย <span class="text-1xl font-bold text-green-300"><?php echo htmlspecialchars($primary_male_count); ?></span> คน</p>
                    <p class="text-lg font-semibold text-white ml-2">หญิง <span class="text-1xl font-bold text-green-300"><?php echo htmlspecialchars($primary_female_count); ?></span> คน</p>
                </div>
                ...
                <div class="bg-yellow-700 p-4 rounded-lg shadow-md">
                    ...
                    <p class="text-lg font-semibold text-white ml-2">ชาย <span class="text-1xl font-bold text-yellow-300"><?php echo htmlspecialchars($lower_secondary_male_count); ?></span> คน</p>
                    <p class="text-lg font-semibold text-white ml-2">หญิง <span class="text-1xl font-bold text-yellow-300"><?php echo htmlspecialchars($lower_secondary_female_count); ?></span> คน</p>
                </div>
                ...
                <div class="bg-red-700 p-4 rounded-lg shadow-md">
                    ...
                    <p class="text-lg font-semibold text-white ml-2">ชาย <span class="text-1xl font-bold text-red-300"><?php echo htmlspecialchars($upper_secondary_male_count); ?></span> คน</p>
                    <p class="text-lg font-semibold text-white ml-2">หญิง <span class="text-1xl font-bold text-red-300"><?php echo htmlspecialchars($upper_secondary_female_count); ?></span> คน</p>
                </div>
                ...
                <div class="bg-purple-700 p-4 rounded-lg shadow-md">
                    ...
                    <p class="text-lg font-semibold text-white ml-2">ครูบรรจุ <span class="text-1xl font-bold text-purple-300"><?php echo htmlspecialchars($krubanju_count); ?></span> คน</p>
                    <p class="text-lg font-semibold text-white ml-2">ครูอัตตราจ้าง <span class="text-1xl font-bold text-purple-300"><?php echo htmlspecialchars($kru_count); ?></span> คน</p>
                </div>
            </div>
