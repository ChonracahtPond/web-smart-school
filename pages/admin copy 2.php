        ...
        <section class="content">
            ...
            switch ($page) {
                case 'users':
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage and view all users in the system.</p>
                ...
                case 'products':
                    echo '
                    <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">Products</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage and view all products in the system.</p>
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 mt-4">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Products List</h2>
                ...
                case 'orders':
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage and view all orders in the system.</p>
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 mt-4">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Orders List</h2>
                ...
                case 'recent-activities':
                    echo '
                    <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">Recent Activities</h1>
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 mt-4">
                ...
                default:
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
                            ...
                            <a href="?page=users" class="mt-2 inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline">View Users</a>
                        </div>
                        <!-- Card 2 -->
                        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
                            ...
                            <a href="?page=products" class="mt-2 inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline">View Products</a>
                        </div>
                        <!-- Card 3 -->
                        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
                            ...
                            <a href="?page=orders" class="mt-2 inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline">View Orders</a>
                        </div>
                    </div>';
                    break;
            }
