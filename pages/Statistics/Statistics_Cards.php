...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
    ...
    <div class="card bg-yellow-100 p-6 rounded-lg shadow-md hover:bg-yellow-200 transition-transform transform hover:scale-105">
        <div class="flex items-center mb-4">
            <i class="fas fa-times-circle fa-2x text-yellow-800 mr-4"></i>
            <h2 class="text-xl font-semibold text-yellow-800">รอการอนุมัติ</h2>
        </div>
        <p class="text-3xl font-bold text-yellow-900"><?php echo htmlspecialchars($Waiting_count); ?> คน</p>
    </div>
</div>