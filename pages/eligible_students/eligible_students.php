...
$sql = "SELECT es.eligible_students_id, es.student_id, es.eligible_type, es.created_at AS date_time, s.student_name 
        ...
        WHERE es.eligible_type = 'class' AND s.status = '0'
        ";
...
<div class="p-8 mt-6 lg:mt-0 rounded-lg shadow bg-white">
    <h1 class="text-3xl font-semibold text-indigo-500 dark:text-white mb-5">นักเรียนที่มีสิทธิสอบ</h1>
    <a href="?page=add_eligible_students" class="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-green-600 flex transition duration-200 mb-5 inline-block w-56">
